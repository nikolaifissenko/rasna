...
**9-seater van rental cost (research, July 2026):** a proper 9-seat minibus (Fiat Ducato/Talento, VW Transporter, Mercedes Vito — enough for 8 guests + 1 guide/driver) runs roughly **€80–150/day** from mainstream rental agencies in the Lazio/Rome area, or **€400–700** for a ~4–5 day rental covering a full group departure. Budget-tier options exist from ~€30/day but are smaller/older vehicles — not realistic for a premium product. Add fuel (~€100–150 for regional day trips to Lago di Vico, Viterbo, Tarquinia, etc.) — so **~€500–850 per group departure** is a reasonable planning number, comfortably inside the existing €140/guest × 8 = €1,120 "local guiding/transport" line in Section 1 (which also needs to cover the driver/guide's time).

**Compliance flag:** a standard **patente B** covers driving a 9-seat vehicle (including driver) for personal/non-commercial use. But since Rasna is transporting *paying* guests as part of a commercial package, this likely falls under **NCC (Noleggio Con Conducente)** rules rather than a simple rental — worth confirming with the commercialista in Phase 4 whether the driver (you, Maria Grazia, or a hired local) needs NCC licensing, or whether contracting a local NCC-licensed driver/service is simpler than trying to self-drive commercially.
