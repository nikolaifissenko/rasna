...
**Emiliano (charcuterie degustazione) — estimated pricing structure:** ~1kg mixed salumi @ ~€25–35/kg (~€30 product cost) + a flat **€50 host fee**. For a group of 8: **~€80 total, ≈€10/guest all-in**. Product cost is an estimate pending Emiliano's actual preventivo — replace once confirmed. See `CONTATTI_LOCALI.md` for details.
