...
**Beccone Albergo** looks like the natural second partner — it's in Blera, has ~20 rooms (up to 60 guests) including singles, triples, and family rooms, which covers exactly what La Ripa can't. Indicative rates found on a third-party listing site (not Booking.com, which doesn't list Beccone for Blera): singles €35–40, doubles €54–60, triples €68–78, family €75–88/night (breakfast included) — **unverified, needs direct confirmation with the property before using in the cost model.** See `CONTATTI_LOCALI.md` for details and contact info.
