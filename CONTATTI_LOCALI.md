...
- **Tariffa indicativa (2026-08-13): €60/persona/notte** — non differenziata per appartamento/tipo camera. **Non è una tariffa fissa/definitiva:** il proprietario è descritto come molto disponibile ("very chill"), quindi il prezzo reale potrebbe essere più basso una volta negoziato — €60 va trattato come stima prudente/tetto massimo, non come numero da cui non muoversi. Per il soggiorno di 6 notti (9–15 novembre), a questa tariffa: **€360/persona**. Vedi `FINANCIAL_PLAN.md` §1 per il ricalcolo del margine — i margini reali potrebbero risultare ancora migliori una volta negoziata una tariffa definitiva. Non serve più usare le tariffe Da Beccone come riferimento provvisorio.
